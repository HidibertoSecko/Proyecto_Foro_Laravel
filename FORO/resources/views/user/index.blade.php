...
<body>
  <br><br><br>
    ...
    <pattern id="wave" x="0" y="0" width="190" height="20" patternUnits="userSpaceOnUse">
  ...
  <text text-anchor="middle" x="60" y="15" font-size="17" fill="url(#wave)"  fill-opacity="0.6">LOGIN</text>
  <text text-anchor="middle" x="60" y="15" font-size="17" fill="url(#gradient)" fill-opacity="0.2">LOGIN</text>
</svg>
