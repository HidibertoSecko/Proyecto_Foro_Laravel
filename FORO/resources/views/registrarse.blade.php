  ...
  <text text-anchor="middle" x="70" y="15" font-size="17" fill="url(#gradient)" fill-opacity="0.2">REGISTRO</text>
    ...
    <section id="login" align="center">
        <form action="login" method="post" accept-charset="utf-8">
            <input width="80%" type="text" name="avatar" id="avatar" placeholder="Nombre de Usuario"><br><br>
            <input type="email" name="email" id="email" placeholder="Correo Electronico"><br><br>
            <input type="password" name="pass" id="pass" placeholder="Contraseña"><br><br>
            <input type="submit" name="" value="REGISTRAR"><br><br>
        </form>
    </section>
</body>
</html>
